                  ...
                  <tr key={item.strategy} className="even:bg-gray-50 text-gray-600">
                    {item.tokenAMint && item.tokenBMint ?
                      <td className="whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3 flex items-center">
                        <img src={item.tokenAMetadata.image || item.tokenAMetadata.logoURI} className="w-auto h-4 mr-2" />
                        {item.tokenAMetadata.symbol}&nbsp;-&nbsp;
                        <img src={item.tokenBMetadata.image || item.tokenBMetadata.logoURI} className="w-auto h-4 mr-2" />
                        {item.tokenBMetadata.symbol}
                      </td>
                      : <td className="whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">(unavailable)</td>}
